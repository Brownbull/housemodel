...
def differentiateMain(log, snap, outCsvPath, statsPath, seeFile, seenFile, newFile, goneFile):
  ...
  outConfirmateFiles.append(newTimeFile)
  outConfirmateFiles.append(goneTimeFile)
  ...
  stepEnd(log, statsSnapStepPath, currStep, outConfirmateFiles)
